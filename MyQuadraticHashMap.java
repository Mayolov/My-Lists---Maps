 ...
 * 7/25/2022
 * 
 * This program is the quadratic version of the 
 * original MyHashMap, which is linear. Quadratic probing
 * uses the Open Addressing scheme to implement itself.This
 * type of probing limits collisions which is why its used in
 * an arraylist. The problem is that it wont visit all the open
 * slots in a hashtable. This program test the MyQuadHashMap class
 * it works like a normal hashmap but introduces a new way to probe.
 */
import java.util.ArrayList;

public class MyQuadraticHashMap {
    public static void main(String[] arg) {
        // Create a map
        MyMap<String, Integer> map = new MyQuadHashMap<>();
        map.put("Mayolo", 30);
        ...
        System.out.println("Is Mayolo in the map? " +
                map.containsKey("Mayolo"));
...
class MyQuadHashMap<K, V> implements MyMap<K, V> {
     ...
     * default load factor
     */
    public MyQuadHashMap(int initialCapacity) {
     ...
     * and load factor
     */
    public MyQuadHashMap(int initialCapacity, float loadFactorThreshold) {
